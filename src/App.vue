  ...
  data() {
    return {
      ...
      hdrs: [
        ...
        "Animesky2.hdr",
        "blouberg.hdr",
        "brownphotostudio.hdr",
        "CasualDay4K.hdr",
        "christmas.hdr",
        "CloudedSunGlow4k.hdr",
        "Cloudymorning4k.hdr",
        "CoriolisNight4k.hdr",
        "cyclorama_hard_light_1k.hdr",
        "cyclorama.hdr",
        "DarkStorm4K.hdr",
      ...
      skyboxes: [
        "CyberinYourFace.glb",
        "DreamlikeLandscape.glb",
        "GreenExplosion.glb",
        "lightbluesky.glb",
        "skyboxanimesky.glb",
        "skyboxautumnforest.glb",
        "skyboxbasicsky.glb",
        "skyboxcityskyline.glb",
        "skyboxinthecloud.glb",
        "freebasicsky.glb",
        "milkyway.glb",
        "spacenebula.glb",
      ],
  ...
  methods: {
    ...
    handleSkyboxPropertyChange({ property, value }) {
      ...
      if (this.$refs.viewer) {
        ...
        this.$refs.viewer.updateSkyboxMaterial({ [property]: value });
    ...
    onViewerMounted() {
      this.$nextTick(() => {
        ...
        console.log(
          "Viewer reference in App.vue after viewer mounted:",
    ...
    handleChangeSkybox() {
      if (this.$refs.viewer && this.$refs.viewer.updateSkybox) {
        this.currentSkyboxIndex =
          (this.currentSkyboxIndex + 1) % this.skyboxes.length;
...
.upload-section {
  ...
  box-shadow: 0px 3px 16px 2px rgba(0, 0, 0, 0.12),
    0px 9px 12px 1px rgba(0, 0, 0, 0.14), 0px 5px 6px -3px rgba(0, 0, 0, 0.2);
}
