...
export default {
  ...
  data() {
    return {
      ...
      initialFloorMaterialProperties: {
        metalness: 0,
        roughness: 0,
        clearcoat: 0,
      ...
      initialPrinterMaterialProperties: {
        metalness: 0,
        roughness: 0,
        clearcoat: 0,
        clearcoatRoughness: 0,
  ...
  methods: {
    ...
    setupRenderer() {
      ...
      this.$refs.rendererContainer.appendChild(
    ...
    updateSkyboxMaterial(properties) {
      console.log("ooooooo", properties);
      ...
      this.$nextTick(() => {
        ...
        if (this.skyboxMaterial) {
          ...
          this.skyboxMaterial.metalness =
            properties.metalness ?? this.skyboxMaterial.metalness;
          console.log(
            "this.skyboxMaterial.metalness: ",
            this.skyboxMaterial.metalness
          );
          this.skyboxMaterial.roughness =
            properties.roughness ?? this.skyboxMaterial.roughness;
          this.skyboxMaterial.clearcoat =
            properties.clearcoat ?? this.skyboxMaterial.clearcoat;
          this.skyboxMaterial.clearcoatRoughness =
            properties.clearcoatRoughness ??
            this.skyboxMaterial.clearcoatRoughness;
          this.skyboxMaterial.reflectivity =
            properties.reflectivity ?? this.skyboxMaterial.reflectivity;
          this.skyboxMaterial.needsUpdate = true; // Tell Three.js to update the material
          console.log("updated material");

          this.floorMesh.children[0].children[0].children[0].material.metalness =
            this.initialFloorMaterialProperties.metalness *
            this.skyboxMaterial.metalness; // Apply the updated material to the mesh

          this.floorMesh.children[0].children[0].children[0].material.roughness =
            this.initialFloorMaterialProperties.roughness *
            this.skyboxMaterial.roughness; // Apply the updated material to the mesh

          this.floorMesh.children[0].children[0].children[0].material.clearcoat =
            this.initialFloorMaterialProperties.clearcoat *
            this.skyboxMaterial.clearcoat; // Apply the updated material to the mesh

          this.floorMesh.children[0].children[0].children[0].material.clearcoatRoughness =
            this.initialFloorMaterialProperties.clearcoatRoughness *
            this.skyboxMaterial.clearcoatRoughness; // Apply the updated material to the mesh

          this.floorMesh.children[0].children[0].children[0].material.reflectivity =
            this.initialFloorMaterialProperties.reflectivity *
            this.skyboxMaterial.reflectivity; // Apply the updated material to the mesh
      ...
      loader.load(
        ...
        (gltfFloor) => {
          if (gltfFloor.scene) {
            ...
            this.initialFloorMaterialProperties = {
              metalness:
                this.floorMesh.children[0].children[0].children[0].material
                  .metalness,
              roughness:
                this.floorMesh.children[0].children[0].children[0].material
                  .roughness,
            ...
            console.error(
              "Failed to load the floor model or scene is undefined."
            );
          }
        },
        undefined,
    ...
    calculateVolume(geometry) {
      ...
      if (!geometry ?? !(geometry instanceof THREE.BufferGeometry)) {
        console.error(
          "Invalid or undefined geometry passed to calculateVolume."
        );
        return 0;
      }
    ...
    loadSTLModel(file) {
      ...
      self.fileReader.onload = (e) => {
        ...
        console.log(
          `STL Model Dimensions: ${dimensions.width / 10} x ${
            dimensions.height / 10
          } x ${dimensions.depth / 10} cm`
        );
